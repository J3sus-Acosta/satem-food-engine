...
const MOCK_PRODUCTS: Product[] = [
  {
    ...
    notes: null,
    sortOrder: 1,
    defaultCategoryId: 'cat_burgers',
    defaultCategoryName: 'Hamburguesas 🍔',
    metadata: {},
    createdAt: new Date(),
    updatedAt: new Date(),
    deletedAt: null,
  },
  {
    ...
    organizationId: 'org_mci',
    sku: 'SKU-BUR-02',
    slug: 'mci-burger-italiana',
    name: 'MCI Burger Italiana',
    description: '150g de vacuno premium, palta hass molida, tomate picado y mayonesa casera.',
    shortDescription: 'Hamburguesa italiana premium.',
    longDescription: '150g de vacuno premium, palta hass molida, tomate picado y mayonesa casera.',
  ...
  },
  {
    ...
    organizationId: 'org_mci',
    sku: 'SKU-SID-01',
    slug: 'papas-fritas-crujientes',
    name: 'Papas Fritas Crujientes',
    description: 'Papas cortadas a mano, doble cocción, crujientes por fuera y tiernas por dentro.',
    shortDescription: 'Papas fritas artesanales.',
    longDescription:
      'Papas cortadas a mano, doble cocción, crujientes por fuera y tiernas por dentro.',
    imageUrl: '/images/products/papas-fritas.webp',
    basePrice: 2990,
    cost: 1000,
    isAlcoholic: false,
    ...
    notes: null,
    sortOrder: 3,
    defaultCategoryId: 'cat_sides',
    defaultCategoryName: 'Acompañamientos 🍟',
    metadata: {},
    createdAt: new Date(),
    updatedAt: new Date(),
    deletedAt: null,
  },
  {
    ...
    shortDescription: 'Coca-Cola sabor original.',
    longDescription: 'Bebida gaseosa refrescante sabor original.',
    imageUrl: '/images/products/coca-cola-original.webp',
    basePrice: 1500,
    cost: 500,
    isAlcoholic: false,
    ...
    notes: null,
    sortOrder: 4,
    defaultCategoryId: 'cat_drinks',
    defaultCategoryName: 'Bebidas 🥤',
    metadata: {},
    createdAt: new Date(),
    updatedAt: new Date(),
    deletedAt: null,
